...
<body>
    ...
    <div class="container">
        <h1 class="form-title text-center">Agregar Empleado</h1>
        <br>
    </div>

    <div class="form-container">
        <form action="InsertarDatos(backend)/InsertarDatosEmpleados.php" method="POST">
            <div class="mb-3">
            ...
            <div class="form-actions text-center">
                <button type="submit" class="btn btn-primary"><i class="fas fa-plus icon"></i> Agregar Empleado</button>
