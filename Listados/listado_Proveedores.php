...
<body>
    <div class="container">
        <h1 class="page-title text-center">Proveedores</h1>
    </div>
    ...
    <div class="container">
        <div class="">
            <div class="add-button-container">
                <a href="../Insertar_Datos/AgregarFormProveedores.php" class="add-button">
                    <i class="fas fa-plus icon"></i> Agregar Proveedor
                </a>
            </div>
        </div>
        <div class="table-wrapper">
            <table id="proveedores-table" class="display">
                <thead>
                    <tr>
                        <th>Id</th>
                        <th>Proveedor</th>
                ...
                <tbody>
                    ...
                    if ($sql) {
                        while ($resultado = $sql->fetch_assoc()) {
                            ?>
                            <tr>
                                <td><?php echo $resultado['ProveedorID'] ?></td>
                                <td><?php echo $resultado['NombreProveedor'] ?></td>
