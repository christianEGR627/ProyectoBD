...
<body>
    ...
    <form class="form-container" action="EditarDatos(backend)/EditarDatosClientes.php" method="POST">
        <?php
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="nombreCliente" name="NombreCliente" value="<?php echo $row['NombreCliente']; ?>">
        </div>
        <div class="mb-3">
