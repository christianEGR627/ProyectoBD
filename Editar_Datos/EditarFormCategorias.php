...
<body>
    ...
    <div class="container">
        <h1 class="form-title text-center">Editar Categorías</h1>
        <br>
    </div>

    <form class="form-container" action="EditarDatos(backend)/EditarDatosCategorias.php" method="post">
        <?php
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="nombreCategoria" name="NombreCategoria" value="<?php echo $row['NombreCategoria'] ?>">
        </div>
        <br>
        ...
        <div class="form-actions text-center">
            ...
            <a href="../Listados/listado_Categorias.php" class="btn btn-secondary"><i class="fas fa-arrow-left icon"></i> Regresar</a>
        </div>
    </form>
